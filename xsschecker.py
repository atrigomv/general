...
##      If execute the script without parameters, show help/><scr\x00ipt>confirm(923650129542903210);</scr\x00ipt><!--','1"/><a href="http://moco.com">Pinche+aqui</a><!--','1"/><a href="http://moco.com" onmous
